...
# run bwa mapping
bwa mem efaecium.contigs.fasta /home/mohamma/genome_analysis/GenomeAnalysisProject/data_links/rna_trimmed_reads/rnaseq_reads/serum_condition/replicate_2/trim_paired_ERR1797970_pass_1.fastq.gz /home/mohamma/genome_analysis/GenomeAnalysisProject/data_links/rna_trimmed_reads/rnaseq_reads/serum_condition/replicate_2/trim_paired_ERR1797970_pass_2.fastq.gz | samtools sort -O BAM -@ 2 -o bwa_rna_serum_rep2_.bam -
